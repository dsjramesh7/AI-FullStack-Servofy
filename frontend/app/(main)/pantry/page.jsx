...
const PantryPage = () => {
  ...
  const {
    ...
    data: updateData,
    fn: updateItem,
  } = useFetchHook(updatePantryItem);

  // load item on inital render
  useEffect(() => {
    fetchItems();
  }, []);
    ...
    <div className="min-h-screen bg-stone-50 pt-24 pb-16 px-4">
      <div className="container mx-auto max-w-5xl">
        ...
        {itemsData?.scansLimit !== undefined && (
          <div className="bg-white py-3 px-4 border-2 border-stone-200 inline-flex items-center gap-3 mb-2">
